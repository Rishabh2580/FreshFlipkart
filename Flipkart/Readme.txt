...
In this e- commerce webiste I haved check the different functionlaities via Automation I have test this website with the help of some tools and frameworks.like i have checked login functionlaity Add to cart functionlaity etc.
...
i have putting failed screenshots in seperate folder name of the folder is screenshot.
